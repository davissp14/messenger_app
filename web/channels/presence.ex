defmodule SecureMessenger.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule SecureMessenger.MyChannel do
        use SecureMessenger.Web, :channel
  ...
  """
  use Phoenix.Presence, otp_app: :secure_messenger,
                        pubsub_server: SecureMessenger.PubSub
end
